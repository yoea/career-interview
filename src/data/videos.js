...
const CATEGORY_RULES = [
  { name: '教育', icon: 'graduation-cap', keywords: ['教师', '校长', '教授', '辅导员', '老师', '教育', '志愿填报', '生涯规划', '职业规划', '生涯发展', '学生会', '培训'] },
  { name: '科技·互联网', icon: 'laptop-code', keywords: ['程序员', '软件', '计算机', '人工智能', '大数据', '芯片', '物联网', '自动驾驶', '自动化', '互联网', '架构师', '产品经理'] },
  { name: '法律', icon: 'scale-balanced', keywords: ['律师', '检察官', '法官', '法律'] },
  { name: '科研·学术', icon: 'flask', keywords: ['科研', '航空科学', '学者', '博士', '科普', '数学教授'] },
  { name: '企业·创业', icon: 'building', keywords: ['企业家', '创业', '民营', '房地产', '人力资源', '商务顾问', '产业园', '高管教练', '总经理'] },
  { name: '金融·财务', icon: 'chart-line', keywords: ['银行', '金融', '保险', '财富', '税务', '审计', '财务'] },
  { name: '媒体·传媒', icon: 'bullhorn', keywords: ['记者', '传媒', '主持', '媒体', '新闻', '宣传', '摄影师', '奥运'] },
  ...
  { name: '文化·艺术', icon: 'pen-nib', keywords: ['诗人', '作家', '书法', '文秘', '写作', '摄影', '街舞', '非遗', '扎染'] },
  ...
  { name: '农业', icon: 'seedling', keywords: ['农业', '牧业', '农场', '畜牧'] },
  { name: '专业技术人员', icon: 'wrench', keywords: ['机长', '飞行员', '技术员', '工程师'] },
